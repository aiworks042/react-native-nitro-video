...
/// Per-URL on-disk index of cached variants.
enum CacheVariantIndex {
  static let fileSuffix = ".variants"
  private static let queue = DispatchQueue(label: "nitro.video.cache.variants")
  ...
  static func indexPath(forUrl url: URL) -> String? {
    ...
    directory.appendPathComponent(VideoCacheManager.expoVideoCacheDirectory, isDirectory: true)
