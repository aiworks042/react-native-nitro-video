///
/// HybridNitroVideoViewManager.kt
...
import com.margelo.nitro.nitrovideo.*

/**
 * Represents the React Native `ViewManager` for the "NitroVideoView" Nitro HybridView.
 */
public class HybridNitroVideoViewManager: SimpleViewManager<View>() {
  /**
  ...
  init {
    if (RecyclableView::class.java.isAssignableFrom(HybridNitroVideoView::class.java)) {
  ...
  override fun createViewInstance(reactContext: ThemedReactContext): View {
    val hybridView = HybridNitroVideoView(reactContext)
  ...
  override fun updateState(view: View, props: ReactStylesDiffMap, stateWrapper: StateWrapper): Any? {
    ...
    HybridNitroVideoViewStateUpdater.updateViewProps(hybridView, newState, oldState)
