...
/**
 * Represents the JavaScript callback `(duration: number) => void`.
...
fun interface Func_void_double: (Double) -> Unit {
  ...
  @DoNotStrip
  @Keep
  override fun invoke(duration: Double): Unit
}
...
class Func_void_double_cxx: Func_void_double {
  ...
  private external fun invoke_cxx(duration: Double): Unit
}
