...
namespace margelo::nitro::nitrovideo {
  ...
  /**
   * The C++ JNI bridge between the C++ enum "VideoPlayerStatus" and the Kotlin enum "VideoPlayerStatus".
   */
  struct JVideoPlayerStatus final: public jni::JavaClass<JVideoPlayerStatus> {
  public:
    static constexpr auto kJavaDescriptor = "Lcom/margelo/nitro/nitrovideo/VideoPlayerStatus;";
