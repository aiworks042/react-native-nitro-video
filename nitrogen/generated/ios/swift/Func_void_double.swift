...
/**
 * Wraps a Swift `(_ duration: Double) -> Void` as a class.
 * This class can be used from C++, e.g. to wrap the Swift closure as a `std::function`.
 */
public final class Func_void_double {
  public typealias bridge = margelo.nitro.nitrovideo.bridge.swift

  private let closure: (_ duration: Double) -> Void

  public init(_ closure: @escaping (_ duration: Double) -> Void) {
    self.closure = closure
  }

  @inline(__always)
  public func call(duration: Double) -> Void {
    self.closure(duration)
  }
